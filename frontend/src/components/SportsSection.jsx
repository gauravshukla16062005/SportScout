...
export default function SportsSection() {
                          ...
                          <div className="mt-7 flex flex-wrap gap-3">
                            ...
                            {sport.features.map((feature) => (
                                              ...
                                              <div className="mt-8 flex items-center justify-between">
                                                ...
                                                <Link to={`/upload/${sport.title.toLowerCase()}`}>
  ...
  >
    ...
    />
                                            ...
                                            <div className="pointer-events-none absolute inset-0 rounded-[30px] border border-red-500/0 transition-all duration-500 group-hover:border-red-500/40"></div>
                              
                                            {/* Bottom Glow */}
                              
                                            <div className="pointer-events-none absolute -bottom-28 left-1/2 h-40 w-40 -translate-x-1/2 rounded-full bg-red-600/20 blur-[80px] opacity-0 transition-all duration-500 group-hover:opacity-100"></div>
